...
- [A Practical Guide to Solana Smart Contract Security](#a-practical-guide-to-solana-smart-contract-security)
  - [Frequent Mistakes in Solana Smart Contract Implementation](#frequent-mistakes-in-solana-smart-contract-implementation)
  ...
  - [Case Analysis](#case-analysis)
    - [Sysvar system account not checked](#sysvar-system-account-not-checked)
        - [Vulnerability example](#vulnerability-example)
        - [FixCode](#fixcode)
    - [The PDA account is used but the caller's account and the beneficiary's account are not checked](#the-pda-account-is-used-but-the-callers-account-and-the-beneficiarys-account-are-not-checked)
        - [Vulnerability example](#vulnerability-example-1)
        - [FixCode](#fixcode-1)


## Frequent Mistakes in Solana Smart Contract Implementation
